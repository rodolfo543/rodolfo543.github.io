# -*- coding: utf-8 -*-
"""
AXS 03 - CRI 78EUS / Opea 78a emissao - calculo em VALOR TOTAL com IPCA e Focus/BCB.

Objetivo
- Recriar o fluxo do CRI AXS III sem imputar PU, VNA, juros, amortizacao ou PMT da Opea/Vortx.
...
- Valor total inicial parametrizado: R$ 144.000.000,00.
- PU de referencia: R$ 1.000,00; quantidade equivalente = valor total / PU.
- Observacao: os documentos enviados indicam emissao original de 103.000 CRI / R$ 103.000.000,00; a base de R$ 144.000.000,00 foi deixada como parametro operacional para bater com a conferencia em valor total. Caso queira o valor documental original, altere VALOR_TOTAL_INICIAL para 103000000.
- Data de emissao dos CRI: 22/11/2022.
- Taxa: IPCA + 11,00% a.a., base 252 dias uteis.
- Juros e amortizacao pagos mensalmente conforme Anexo I.
- Vencimento final: 17/11/2036.

Ajuste importante
- A data da primeira integralizacao efetiva foi parametrizada como 28/11/2022. Esta data afeta o primeiro periodo de IPCA/juros e corrige a diferenca proporcional constante observada usando 01/12/2022.
...
Como rodar
    python axs03_cri_v4_total_focus_bcb_xlsx.py

Dependencias opcionais
    pip install openpyxl python-bcb

Arquivos gerados
    controle_divida_axs03_cri_v4_total.csv
    controle_divida_axs03_cri_v4_total.xlsx
"""
...
DATA_EMISSAO = date(2022, 11, 22)
DATA_INICIO_RENTABILIDADE = date(2022, 11, 29)
DATA_VENCIMENTO = date(2036, 11, 17)
...
def salvar_xlsx(linhas: List[Dict[str, object]], caminho: Path, fonte_sidra: str, fonte_focus: str) -> None:
    ...
    tab = Table(displayName="TabelaControleAXS03CRITotal", ref=f"A1:{get_column_letter(ws.max_column)}{ws.max_row}")
    ...
    ws["A1"].comment = Comment("AXS 03 CRI: calculo por metodologia em valor total, sem imputar PU/VNA/PMT da Opea/Vortx.", "ChatGPT")
...
def main() -> None:
    ...
    out_csv = Path("controle_divida_axs03_cri_v4_total.csv")
    out_xlsx = Path("controle_divida_axs03_cri_v4_total.xlsx")
